...
function renderErrorMessage(error: Error | unknown) {
  ...
  if (typeof error === "string") {
    return (
      <>
        <h1 className={errorBoundaryClasses.title}>Application Error</h1>
        <p className={errorBoundaryClasses.message}>{error}</p>
      </>
    );
  }
